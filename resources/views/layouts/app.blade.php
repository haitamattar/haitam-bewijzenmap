...
<head>
    ...
    <title>Bewijzenmap Haitam</title>
    ...
    <nav class="navbar navbar-default custom-nav-bar">
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="app-navbar-collapse">
                <!-- Left Side Of Navbar -->
                <ul class="nav navbar-nav active-menu-btn">
                ...
                <ul class="nav navbar-nav navbar-right">
                    ...
                    @else
                        <li class="dropdown">
                            <a href="#" class="dropdown-toggle customAccountHover" data-toggle="dropdown" role="button" aria-expanded="false">
